...
QUEUE_URL = "http://localhost:4566/000000000000/pedido_lines_queue"

_BODY = {"operation": "SOLICITAR", "order_id": None, "parsed": {}}
...
def test_process_once_does_not_ack_or_mark_technical_error(
    ...
    mark = MagicMock()
    monkeypatch.setattr(worker_loop, "mark_message_processed", mark)
    handler = MagicMock(side_effect=RuntimeError("api-gateway respondeu 502"))
